...
PathCls.graph_sample_path(
    ...
    title='Survival curve of Those Without Therapy',
...
Figs.graph_histogram(
    ...
    title='Survival times of patients with No Therapy',
    x_label='Survival time (years)',
    y_label='Counts',
    bin_width=1
)

# print the outcomes of this simulated cohort with no therapy
